		...
		<div class="greeting-flex-box">
			...
			<div class="greeting-text-box">
				<div class="highlight-welcome">
					'홍제감리교회'에 오신<br> 여러분을 환영합니다.
				</div>

				<p>홍제감리교회는 하나님께서 1921년 서대문구 홍제동에 하나님의 역사를 위해 세우신 교회입니다.</p>
				<p>그동안 많은 신앙의 선배님들이 이 제단을 통하여 예수님의 제자가 되어 이 세상에서 빛과 소금의 역할을
					감당하셨습니다.</p>
				<p>저희 교회는 그 전통을 이어받아, 무엇보다 예수님을 닮아가며 진정한 예수님의 제자들로 거듭나기를 소망하는
					공동체입니다.</p>
				<p>또한 다음 세대들에게 예수 그리스도를 전하여 하나님께서 귀하게 사용하시는 사명자들로 세우는 일에 최선을 다하고
					있습니다.</p>
				<p>앞으로도 예수 그리스도의 복음을 위하여 말씀 안에서 하나가 되어 전도하고 기도하며 이 세상에서 빛과 소금의
					역할을 감당하기 위해 열심히 달려 나가려고 합니다.</p>
				<p style="margin-top: 30px; font-weight: bold;">이 공동체에 여러분을
					초대합니다.</p>
			</div>
